...
namespace Hospital
{
    internal class Program
    {
        ...
        {
            //Cannot update information by creating with id included. Needs update in sql
            Patient Anthony = new Patient(1,"Anthony", new DateOnly(1995, 07, 31), "Teacher Syndrome","HELP");
            ...
            Patient Collin = new Patient(4,"Collin", new DateOnly(1991, 3, 16), "FullStackDev Syndrome","Talks too much");
